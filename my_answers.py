...
#         print('weights_hidden_to_output',self.weights_hidden_to_output.shape)
        #weights_hidden_to_output->self.hidden_nodes, self.output_nodes
        #hidden_error->self.hidden_nodes, self.output_nodes
        ...
        #hidden_error_term->self.hidden_nodes, self.output_nodes
        hidden_error_term = hidden_error.reshape(hidden_outputs.shape)*hidden_outputs*(1-hidden_outputs)
    
#         print('hidden_error_term',hidden_error_term.shape)
        # Weight step (input to hidden)
        #delta_weights_i_h->self.input_nodes, self.hidden_nodes
        #
        delta_weights_i_h +=X[:,None]*hidden_error_term.T
        # Weight step (hidden to output)
        #delta_weights_h_o->self.hidden_nodes, self.output_nodes
